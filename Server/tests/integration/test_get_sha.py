...
async def test_get_sha_param_shape_and_routing(monkeypatch):
    ...
    async def fake_send(cmd, params, **kwargs):
        ...
        return {"success": True, "data": {"sha256": "abc", "lengthBytes": 1, "lastModifiedUtc": "2020-01-01T00:00:00Z", "uri": "junglemcp://path/Assets/Scripts/A.cs", "path": "Assets/Scripts/A.cs"}}
    ...
    resp = await get_sha(DummyContext(), uri="junglemcp://path/Assets/Scripts/A.cs")
