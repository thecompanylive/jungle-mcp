...
async def apply_text_edits(
    ctx: Context,
    uri: Annotated[str, "URI of the script to edit under Assets/ directory, junglemcp://path/Assets/... or file://... or Assets/..."],
...
async def delete_script(
    ctx: Context,
    uri: Annotated[str, "URI of the script to delete under Assets/ directory, junglemcp://path/Assets/... or file://... or Assets/..."],
) -> dict[str, Any]:
...
async def validate_script(
    ctx: Context,
    uri: Annotated[str, "URI of the script to validate under Assets/ directory, junglemcp://path/Assets/... or file://... or Assets/..."],
