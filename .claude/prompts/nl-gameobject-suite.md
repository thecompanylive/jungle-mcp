...
- Call `mcp__UnityMCP__read_resource(uri="junglemcp://scene/gameobject/{instanceID}")` replacing {instanceID} with the actual ID
...
**Actions**:
- Use the instance ID from GO-1
- Call `mcp__UnityMCP__read_resource(uri="junglemcp://scene/gameobject/{instanceID}/components")` replacing {instanceID} with the actual ID
...
- Call `mcp__UnityMCP__read_resource(uri="junglemcp://scene/gameobject/{instanceID}/component/Rigidbody")` replacing {instanceID}
...
### New Resources  
- `junglemcp://scene/gameobject/{instanceID}` - Single GameObject data
- `junglemcp://scene/gameobject/{instanceID}/components` - All components (paginated)
- `junglemcp://scene/gameobject/{instanceID}/component/{componentName}` - Single component
