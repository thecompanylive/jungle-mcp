...
1) Pick target file (prefer):
   - `junglemcp://path/Assets/Scripts/LongUnityScriptClaudeTest.cs`
...
- **Canonical URIs only**:
  - Primary: `junglemcp://path/Assets/...` (never embed `project_root` in the URI)
...
**Actions**:
- Make identical edit using `junglemcp://path/Assets/Scripts/LongUnityScriptClaudeTest.cs`
